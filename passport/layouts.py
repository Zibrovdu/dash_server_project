...
def serve_layout():
    ...
    tooltips_table_site = [
        {'Визиты': 'Суммарное количество визитов.', 'Посетители': 'Количество уникальных посетителей.',
                    ...
                    dcc.Tab(label='Сайт', value='s', children=[
                        ...
                        html.Div([
                            html.Div([dcc.Graph(id='el_budget_graph_mean_time')], className='line_block',
                                     style=dict(width='37%')),
                            html.Div([dcc.Graph(id='el_budget_graph')], className='line_block',
                                     style=dict(width='56%')),
                            html.Div([dcc.Graph(id='gossluzba_pagedept')], className='line_block',
                                     style=dict(width='46%')),
                            html.Div([dcc.Graph(id='gossluzba_visits')], className='line_block',
                                     style=dict(width='46%'))
                        ]),
